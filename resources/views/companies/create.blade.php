...
<div class="card card-primary">
    ...
    <div class="form-group">
        ...
        <input type="text"  name="name" class="form-control" id="companyName" placeholder="Enter Company name"
            value="{{old('name')}}">
        @error('name')
    ...
    <div class="form-group">
        ...
        <input type="text" name="logo" class="form-control" id="companyLogo" placeholder="Enter Website" value="{{old('logo')}}">
        @error('logo')
            <div class="text-red-680 text-sm">{{$message}}</div>
        @enderror
    </div>
